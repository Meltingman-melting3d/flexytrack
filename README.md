# flexytrack
# FlexyTrack is a Blender extension that automatically applies chained Damped Track constraints from the active bone through its descendants.  It is designed for simple bone chains and physics-free motion control.
## Features
